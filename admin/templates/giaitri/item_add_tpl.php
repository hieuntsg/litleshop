...
function get_main_item()
	{
		$sql_huyen="select * from table_giaitri_item order by stt,id desc ";
...
?>
<form name="frm" method="post" action="index.php?com=giaitri&act=save" enctype="multipart/form-data" class="nhaplieu">
...
<br /> -->
   ...
   <?php //if (@$_REQUEST['act']=='edit'){?>
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=giaitri&act=man'" class="btn" />
</form>