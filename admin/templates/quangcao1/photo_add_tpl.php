<script language="javascript">				
	...
	{				
		...
		window.location ="index.php?com=quangcao1&act=add_photo&id_cat="+b.value;	
		return true;
	}
	...
	{	
		...
		window.location ="index.php?com=quangcao1&act=add_photo&id_cat="+b.value+"&id_list="+c.value;	
		return true;
	}
	...
	{	
		...
		window.location ="index.php?com=quangcao1&act=add_photo&id_cat="+b.value+"&id_list="+c.value+"&id_item="+x.value;	
		return true;
	}
</script>
<?php
...
<form name="frm" method="post" action="index.php?com=quangcao1&act=save_photo" enctype="multipart/form-data" class="nhaplieu">
	...
	<br />
	<b>Hình ảnh </b> <input type="file" name="file" /> <strong>.jpg&nbsp;|&nbsp;.gif&nbsp;|&nbsp;png (w:744px;h:1020)(Tỉ lệ: 1:2,1:3...)</strong><br />
    <br />
...
<div style="float: left;width:200px;margin-right:20px;">	
    ...
    <select name="prolist[]" size="10" multiple="multiple" tabindex="10" style="width:200px;">
    	<?php foreach ($result_pro as $kp => $vp) { ?>
        	<option value="<?=$vp['id']?>"><?=$vp['ten']?></option>
        <?php } ?>
    </select>
</div>    
<?php } ?>
