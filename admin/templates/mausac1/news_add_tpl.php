...
<h3><span>Thêm hình</span><a href="index.php?com=mausac1&amp;act=default&id_product=<?=$_REQUEST['id_product']?>" class="top-back">« Quay lại</a></h3>
<form name="frm" method="post" action="index.php?com=mausac1&amp;act=save&id_product=<?=$_REQUEST['id_product']?>" enctype="multipart/form-data" class="nhaplieu">
    	<!-- <div class="a-field">
    	<b> Size:</b>
        <div class="input-box">
        <input type="text" name="ten" value="<?=$news['ten']?>" class="input" /></span></div><br/>
        </div> -->
    <!-- Short Description-->
    ...
    <div class="a-field">
        ...
        <div class="input-box">
        	<img src="<?=_upload_sanpham.$news['photo']?>" alt="NO PHOTO"  width="150"/>
		</div>
    </div> 
	<?php endif;?>
    <!-- End Short Description-->
     ...
     <div class="a-field">
        <div class="input-box">
          ...
          <?=_news_type?> (w:744px;h:1020)(Tỉ lệ: 1:2,1:3...)
    ...
    <div class="a-field">
        ...
        <div class="input-box">
			...
			<input type="button" value="Hủy bỏ" onclick="javascript:window.location='index.php?com=mausac1&act=default&id_product=<?=$_REQUEST['id_product']?>'" class="gray-btn cancel" style="width:100px;" />
        </div>
    </div>
