...
<form name="frm" method="post" action="index.php?com=thanhvien&act=savevip" enctype="multipart/form-data" class="nhaplieu">

	
	<b>Tên thành viên</b> <input disabled="disabled" type="text" name="tenhoasi" id="tenhoasi" value="<?=@$item['firstname']." ".@$item['lastname']?>" class="input" /><br />	
	...
	<b>Khóa</b> <input type="checkbox" name="khoa" <?=(!isset($item['khoa']) || $item['khoa']=='1')?'checked="checked"':''?>><br /><br />
