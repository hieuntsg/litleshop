...
<form name="frm" method="post" action="index.php?com=thanhvien&act=savecodevip" enctype="multipart/form-data" class="nhaplieu">
	...
	<b>Ngày đóng phí</b> <input disabled="disabled" name="ngaydongphi" id="popupDatepicker" placeholder="Nam-Thang-Ngay (2014-07-08)" type="text"   value="<?=@$item['ngaydongphi']?>" class="input" /> <br />
	...
	<input type="submit" value="Tạo mã" class="btn" />
