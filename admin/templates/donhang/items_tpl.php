...
<table class="blue_table">
	...
	<tr>
		...
		<td style="width:15%;" align="center"><a href="index.php?com=order&act=edit&id=<?=$items[$i]['id']?>" style="text-decoration:none;"><?=$items[$i]['hoten']?></a></td>
		<td style="width:15%;" align="center"><a href="index.php?com=order&act=edit&id=<?=$items[$i]['id']?>" style="text-decoration:none;"><?=$items[$i]['email']?></a></td>
		  <td style="width:10%;" align="center"><?=date('d/m/Y',$items[$i]['ngaytao'])?></td>          
           <td style="width:10%;" align="center"><?=number_format($items[$i]['tonggia'],0, ',', '.')?>&nbsp;VNĐ</td>
            <!--<td style="width:10%;" align="center"><?//=$items[$i]['httt']?></td>-->
            <td style="width:10%;" align="center"><a href="index.php?com=order&act=edit&id=<?=$items[$i]['id']?>" style="text-decoration:none;">Xem đơn hàng</a></td>
