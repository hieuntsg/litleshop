<h3>Hình ảnh</h3>
<form name="frm" method="post" action="index.php?com=logodoitac&act=save_photo" enctype="multipart/form-data" class="nhaplieu">
<?php for($i=0; $i<5; $i++){?>	
...
<? }?>
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=logodoitac&act=man_photo'" class="btn" />
</form>