...
<form name="frm" method="post" action="index.php?com=logodoitac&act=save_photo&id=<?=$_REQUEST['id'];?>&idc=<?=$_REQUEST['idc']?>" enctype="multipart/form-data" class="nhaplieu">	
	<!--<b>&nbsp;</b> 
	...
	<!--<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=logodoitac&act=edit_photo&id=4'" class="btn" />-->
</form>