...
function get_main_item()
	{
		$sql_huyen="select * from table_infodoitac_item order by stt,id desc ";
...
?>
<form name="frm" method="post" action="index.php?com=infodoitac&act=save" enctype="multipart/form-data" class="nhaplieu">
   ...
   <?php if (@$_REQUEST['act']=='edit')
	...
	<b>Link</b>
	<div>
    	<input type="text" name="mota" value="<?=@$item['mota']?>" class="input" /><br />
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=infodoitac&act=man'" class="btn" />
</form>